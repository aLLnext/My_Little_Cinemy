...
<#assign script>
    <script>
        ...
        function showrow() {
            ...
            var name = document.getElementById('count_name');
...
<!-- Modal -->
<div class="modal fade" id="buyticket" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
     aria-hidden="true">
            ...
            <div id="modalbody" class="modal-body"></div>
                <div style="text-align: center">
                    <div style="display: inline-block; width: 100%">
                        ...
                        <p style="display: inline-block">НашКинотеатр </p>
                        <p style="display: inline-block">vip зал</p>
                    </div>
                    <div style="display: inline-block; width: 100%">
                        <p style="display: inline-block"><b>Дата, время  </b></p>
                        <p style="display: inline-block">Дата </p>
                        <p style="display: inline-block">время </p>
                    </div>
                    <div style="display: inline-block; width: 100%">
                        <p><b>Ограничение по возрасту</b></p>
